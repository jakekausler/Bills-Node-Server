 ...
 * ```
 */
export function getCalendarBills(request) {
            ...
            if (activity.billId) {
                ...
                if (activity.isTransfer) {
                    ...
                    if (activity.amount < 0) {
                        bill = getById(data.accountsAndTransfers.transfers.bills, activity.billId);
                    }
                    else {
                        continue;
                    }
                    ...
                    bill = getById(account.bills, activity.billId);
                }
                ret.push({
