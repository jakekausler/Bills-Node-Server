...
export function handlePension(accountsAndTransfers, pensions, currDate, balanceMap, idxMap) {
...
function getHighestCompensationAverage(accountsAndTransfers, pension) {
    ...
    const averageConsecutiveYearPays = [];
