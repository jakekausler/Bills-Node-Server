 ...
 */
export function getAccountInterests(request) {
 ...
 */
export function addInterest(request) {
    const data = getData(request);
    const account = getById(data.accountsAndTransfers.accounts, request.params.accountId);
 ...
 */
export function updateInterest(request) {
 ...
 * @returns null
 */
export function deleteInterest(request) {
    const data = getData(request);
    const account = getById(data.accountsAndTransfers.accounts, request.params.accountId);
    account.interests = [];
    saveData(data.accountsAndTransfers);
