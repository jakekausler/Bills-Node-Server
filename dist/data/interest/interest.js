...
export class Interest {
    ...
    constructor(data, simulation = 'Default') {
        ...
        const { amount: apr, amountIsVariable: aprIsVariable, amountVariable: aprVariable, } = loadNumberOrVariable(data.apr, data.aprIsVariable, data.aprVariable, simulation);
        this.apr = apr;
        this.aprIsVariable = aprIsVariable;
        this.aprVariable = aprVariable;
        this.compounded = data.compounded;
        const { date: applicableDate, dateIsVariable: applicableDateIsVariable, dateVariable: applicableDateVariable, } = loadDateOrVariable(data.applicableDate, data.applicableDateIsVariable, data.applicableDateVariable, simulation);
 ...
 */
export function insertInterest(account, interest, data, simulation = 'Default') {
 ...
 */
export function compoundInterest(balance, apr, compounded) {
    if (compounded === 'day') {
