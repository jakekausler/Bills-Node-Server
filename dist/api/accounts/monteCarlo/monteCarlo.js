...
export function monteCarlo(req) {
    const data = getData(req);
    const accountsAndTransfers = data.accountsAndTransfers;
    const nSimulations = parseFloat(req.query.nSimulations);
    ...
    const results = monteCarloCalculation(accountsAndTransfers, nSimulations, 
    // startDate,
    // endDate,
    simulation, useExistingSimulations, selectedAccounts);
    return results;
}
