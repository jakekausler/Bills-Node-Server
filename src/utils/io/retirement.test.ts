  ...
  describe('loadPensionsAndSocialSecurity', () => {
        ...
        pensions: [
          {
            ...
            startDateVariable: 'pensionStartDate',
        ...
        pensions: [
          {
            ...
            paycheckAccounts: [],
            paycheckCategories: [],
            startDateVariable: 'var1',
            birthDateVariable: 'var2',
      ...
      const mockData = {
        pensions: [
          ...
          },
          {
            ...
            paycheckAccounts: [],
            paycheckCategories: [],
            startDateVariable: 'var4',
            birthDateVariable: 'var5',
      ...
      const mockData = {
        ...
        socialSecurities: [
          ...
          },
          {
            ...
            paycheckAccounts: [],
            paycheckCategories: [],
            startDateVariable: 'var3',
            birthDateVariable: 'var4',
            priorAnnualNetIncomes: [],
            priorAnnualNetIncomeYears: [],
          },
        ],
        ...
        socialSecurities: [
          {
            ...
            paycheckAccounts: [],
            paycheckCategories: [],
            startDateVariable: 'var7',
            birthDateVariable: 'var8',
            priorAnnualNetIncomes: [],
            priorAnnualNetIncomeYears: [],
          },
          {
            ...
            paycheckAccounts: [],
            paycheckCategories: [],
            startDateVariable: 'var9',
            birthDateVariable: 'var10',
            priorAnnualNetIncomes: [],
            priorAnnualNetIncomeYears: [],
          },
        ],
    ...
    it('should maintain data integrity when creating instances', () => {
      const pensionData = {
        ...
        startDateVariable: 'startVar',
        birthDateVariable: 'birthVar',
      ...
      const ssData = {
        ...
        startDateVariable: 'ssStartVar',
        birthDateVariable: 'birthVar2',
